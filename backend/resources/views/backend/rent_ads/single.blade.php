            ...
            <ul class="list-group">
                <li class="list-group-item d-flex justify-content-center align-items-center flex-column">
                    <div class="rent-ad-image-container">
                        ...
                        <img src="{{asset($rentAd->image)}}" alt="ad_image" class="img-fluid">
                        @else
            ...
            <form action="{{route('manage.rent_ads.update', ['role'=>Auth::user()->role, 'id'=>$rentAd->id])}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="form-control">
                        <option @if ($rentAd->status == 2)
                            selected
                        @endif value="2" >Pending</option>
                        <option @if ($rentAd->status == 1)
                            selected
                        @endif value="1">Approved</option>
                        <option @if ($rentAd->status == 0)
                            selected
                        @endif value="0">Rejected</option>
                        <option @if ($rentAd->status == 3)
                            selected
                        @endif value="3">Modifications Required</option>
                    </select>
                </div>
