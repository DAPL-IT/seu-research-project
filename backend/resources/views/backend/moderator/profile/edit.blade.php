                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nameField" name="name" value="{{ $auth_moderator->name }}" >
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="emailField">Email</label>
                                    <input type="email" class="form-control" id="emailField" name="email" value="{{ $auth_moderator->email }}" >
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="phoneField">Phone</label>
                                    <input type="text" class="form-control" id="phoneField" name="phone" value="{{ $auth_moderator->phone }}" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="currAddrField">Current Address</label>
                                    <textarea class="form-control" name="current_address" id="currAddrField" rows="3">{{ $auth_moderator->current_address }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="parAddrField">Parmanent Address</label>
                                    <textarea class="form-control" name="permanent_address" id="parAddrField" rows="3" placeholder="Leave it empty if Parmanent Addr. is same as Current Addr.">{{ $auth_moderator->permanent_address }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
